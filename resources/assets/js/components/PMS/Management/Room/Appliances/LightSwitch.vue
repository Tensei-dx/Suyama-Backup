<template>
    <div class="card mb-4">
        <div class="rounded hotel-base-color w-100 py-2">
            <h3 class="text-black text-center my-0"><img src="img/guest_dashboard/light-bulb.png"
                     style="width: 30px; margin-right: 10px" />{{ this.deviceInfo.APPLIANCE_NAME }}</h3>
        </div>
        <div class="p-1 align-self-center text-black text-center">
            <div class="row align-self-center w-100 mx-0 py-2">
                <div class="col-12 px-0 light-panel text-center pb-2">
                            ...
                            <div class="row no-gutters justify-content-around">
                                <div class="col-6 text-center">
                                    <div class="btn-group-vertical">
                                        ...
                                        <small class="d-block w-100">{{ $t('mobile.control.lights.up') }}</small>
                                        ...
                                        <small class="d-block w-100">{{ $t('mobile.control.lights.down') }}</small>
                                    </div>
                                </div>
                                <div class="col-6 pt-4 mt-2">
                                    <div class="btn-group-vertical">
                                        ...
                                        <small
                                               class="d-block w-100 pt-1">{{ $t('mobile.control.lights.night') }}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row px-0 w-100 mx-0">
                        <div class="col-6">
                            <div class="btn-group-vertical">
                                ...
                                <small class="d-block w-100 pt-1">{{ $t('mobile.control.lights.on') }}</small>
                                <button class="button-img hotel-white-color-text" :disabled="isEmpty"
                                ...
                                <!-- https://icons8.com/icons/set/fan-white--white -->
                                <small class="d-block w-100 pt-1">{{ $t('mobile.control.lights.off') }}</small>
                            </div>
                        </div>
