<!--Created by TP.Shannie 05/18/21 -->
<template>
    <!-- <div class="row align-items-center">
        ...
        <div class="col p-3" style="color:black; text-align:center;">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-6">
                            <div class="btn-group-vertical">
                                ...
                                <button type="button" class="btn btn-secondary d-block"
                                        @click="clickRemote('fanspeed_down')">
                                    <i class="fa fa-minus" aria-hidden="true"></i>
                                </button>
                            </div>
                        ...
                        <div class="col-6">
                            <div class="btn-group-vertical">
                                <button type="button" class="btn btn-secondary d-block justify-center"
                                        @click="clickRemote('channel_up')">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-secondary d-block"
                                        @click="clickRemote('channel_down')">
                                    <i class="fa fa-minus" aria-hidden="true"></i>
                                </button>
                            </div>
                            <small class="d-block text-center">CHANNEL</small>
                        </div>
                        <div class="col-6">
                            <div class="btn-group-vertical">
                                <button type="button" class="btn btn-secondary d-block justify-center"
                                        @click="clickRemote('volume_up')">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </button>
                                <button type="button" class="btn btn-secondary d-block"
                                        @click="clickRemote('volume_down')">
                                    <i class="fa fa-minus" aria-hidden="true"></i>
                                </button>
                            </div>
                            <small class="d-block text-center">VOLUME</small>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div>
        <div class="rounded hotel-base-color w-100 py-2">
            <h3 class="text-black text-center my-0">IR Remote NR</h3>
        </div>
    ...
    methods: {
        ...
        clickRemote(data) {
            ...
            if (data == 'power') {
                ...
                this.commandStatus = ''
                // Channel+ button process
            } else if (data == 'channel_up') {
                console.log('You clicked the channel_up button')
                console.log('Please add process to channel_up button')
                this.commandStatus = ''
                // Channel- button process
            } else if (data == 'channel_down') {
                console.log('You clicked the channel_down button')
                console.log('Please add process to channel_down button')
                this.commandStatus = ''
                // Volume+ button process
            } else if (data == 'volume_up') {
                console.log('You clicked the volume_up button')
                console.log('Please add process to volume_up button')
                this.commandStatus = ''
                // Volume- button process
            } else if (data == 'volume_down') {
                console.log('You clicked the volume_down button')
                console.log('Please add process to volume_down button')
                this.commandStatus = ''
                // Error case
            } else {
