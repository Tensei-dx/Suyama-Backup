<template>
    <!-- <div class="row">
        <div class="col" style="background-color:white; color:white; text-align:center;">
            <img src="/img/ManagementDashboard/realdevices/embedded_switch.png" style="max-width:100%; margin-top:10px;"
                 class="img-fluid"><br>
    ...
    <div>
        <div class="rounded hotel-base-color w-100 py-2">
            <h3 class="text-black text-center my-0">3rd Embedded Switch</h3>
        </div>
        <div class="row px-3 py-4">
            <div class="col-4 device-image align-middle">
                <img src="/img/ManagementDashboard/realdevices/embedded_switch.png"
