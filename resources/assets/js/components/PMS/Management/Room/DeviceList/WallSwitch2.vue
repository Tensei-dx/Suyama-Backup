<template>
    <!-- <div class="row">
        <div class="col" style="background-color:white; color:black; text-align:center;">
            <img src="/img/ManagementDashboard/realdevices/wall_switch_2.png" style="max-width:100%; margin-top:10px;" class="img-fluid"><br>
        ...
        <div class="col" style="background-color:white; color:black; text-align:center; margin-right:50px; margin-left:50px; margin-top:10px; margin-bottom:10px;">
            <div class="row"  v-for="(item, index) in wall_switch.data" :key="index">
                <div class="col">
                    <button v-if="item.status == true" type="button" class="btn hotel-base-color" :id="'wall_switch_index_' + index" @click="toggleOnOff(wall_switch, index, 0)"><b>ON</b></button>
                    <button v-else type="button" class="btn hotel-theme-color-2" :id="'wall_switch_index_' + index" @click="toggleOnOff(wall_switch, index, 1)">OFF</button>
    ...
    <div>
        <div class="rounded hotel-base-color w-100 py-2">
            <h3 class="text-black text-center my-0">2nd Wall Switch</h3>
        </div>
        <div class="row px-3 py-4">
            <div class="col-4 device-image align-middle">
                <img src="/img/ManagementDashboard/realdevices/wall_switch_2.png"
