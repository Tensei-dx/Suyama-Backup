            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="">
                            ...
                            <select class="custom-select" v-model="info.REMOTE_TYPE" @change="chooseRemote()"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" :class="{'border border-danger':errors['info.CONTROLLER_NAME']}"
                               type="text" v-model="info.CONTROLLER_NAME">
                        <!-- display this when error occured -->
                        <small v-if="errors['info.CONTROLLER_NAME']"
                               class="text-danger">{{ errors['info.CONTROLLER_NAME'][0] }}</small>
                    </div>
                    <!-- TV display -->
                    <!-- check remote type -->
                        ...
                        <div class="form-group">
                            <div class="">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="#" class="" data-toggle="tooltip" data-placement="right"
                                       title="Learn new command from Remote" @click="learn_mode()">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="text-center">
                                                ...
                                                <button class="btn border border-secondary bg-light"
                                                        v-model="info.AIRCON_POWER" @click="learn('power')"
                                                        :disabled="btnDisabled">
                                                    <!-- change the background using the power_learn in every button -->
                                                    <i class="fa fa-power-off fa-5x fa-fw text-secondary"
                                                       :class="power_learn"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <div class="text-center">
                                                ...
                                                <!-- enable/disabled button using btnDisabled on line 258-->
                                                <button class="btn border border-secondary bg-light"
                                                        v-model="info.AIRCON_TEMP_UP" @click="learn('temp_up')"
                                                        :disabled="btnDisabled">
                                                    <!-- change the background using the power_learn in every button -->
                                                    <i class="fa fa-chevron-up fa-5x fa-fw text-secondary"
                                                       :class="temp_up_learn"></i>
                                                </button>
                                                <!-- call learn function on line 231-->
                                                <!-- enable/disabled button using btnDisabled on line 258-->
                                                <button class="btn border border-secondary bg-light"
                                                        v-model="info.AIRCON_TEMP_DOWN" @click="learn('temp_down')"
                                                        :disabled="btnDisabled">
                                                    <!-- change the background using the power_learn in every button -->
                                                    <i class="fa fa-chevron-down fa-5x fa-fw text-secondary"
                                                       :class="temp_down_learn"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary"
                            @click="btn == 'Cancel' ? learn_mode() : close()">{{ btn }}</button>
                </div>
                <!-- modal footer end -->
            </div>
            <!-- modal content end -->
...
export default {
    ...
    methods: {
        ...
        close() {
            ;(this.errors = {}), (this.loading = false), (this.learning = false)
            this.info.AIRCON_POWER = false
            this.info.AIRCON_TEMP_UP = false
            this.info.AIRCON_TEMP_DOWN = false
            this.info.CONTROLLER_NAME = null
            this.btn = 'Close'
            ;(this.btn_text = 'Save'), this.$emit('loaddata', this.currentPage), this.$emit('close')
        },
        //Function Name: errs
        ...
        errs(error) {
            ...
            ;(this.loading = false), (this.btn_text = 'Save')
        },
    ...
    mounted() {
        Echo.channel('ir-event').listen('IREvent', value => {
            console.log('learned')
