{{--
    <System Name> iBMS
    <Program Name> app.blade.php
    <Create>           TP Bryan
    <Update> 2019.9.3  TP Jethro Added comment header
            2021.9.02 TP Leo   [Sprint04] [Task117] Comment Floor Management
--}}
<!DOCTYPE html>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item {{ Request::is('/') ? 'active' : '' }}">
                        <a class="nav-link" href="/">
                            <i class="fa fa-fw fa-dashboard fa-blinking"></i>
                    ...
                    @if (count(array_intersect(['Gateway Management', 'Device Management', 'Binding Management', 'IR Management'], $modules)) != 0)
                        <li
                            class="nav-item dropdown {{ Request::is('gateway-management*') || Request::is('device-management*') || Request::is('binding-management*') || Request::is('ir-management*') ? 'active' : '' }}">
                            ...
                            <div class="dropdown-menu nav-hardware">
                                @if (in_array('Gateway Management', $modules))
                                    <a id="gatewaym" class="dropdown-item" href="gateway-management">Gateway
                                        Management</a>
                                @endif
                                @if (in_array('Device Management', $modules))
                                    <a id="devicem" class="dropdown-item" href="device-management">Device
                                        Management</a>
                                @endif
                                @if (in_array('Binding Management', $modules))
                                    <a id="bindingm" class="dropdown-item" href="binding-management">Binding
                                        Management</a>
                                @endif
                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-profile-dropdown">
                            ...
                            <div class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" class="dropdown-item" @click="changeLocale('ko')">한국어</a></li>
                                    {{-- <li><a href="#" class="dropdown-item" @click="changeLocale('ch_s')">日中文(简体)本語</a></li> --}}
                                    <li><a href="#" class="dropdown-item" @click="changeLocale('ch_t')">中文(繁體)</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
        ...
        <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="logoutMessage">Select "Logout" below if you are ready to end your
                        current session.</div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary" type="button" data-dismiss="modal" id="cancel">Cancel</button>
                        <a class="btn btn-primary" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                            id="confirmLogout">Logout</a>
                    </div>
