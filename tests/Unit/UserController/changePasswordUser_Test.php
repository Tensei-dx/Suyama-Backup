...
/**
 * <System Name> iBMS
 * <Program Name> changePasswordUser_Test.php
 *
...
/**
 * <Class Name> UserController_changePasswordUser
 *
 * <Overview> Class that is used to perform PHPUnit test
 *            to changePasswordUser method in UserController
 * @package Test
 * @author TP Uddin <u-almujeer@tenseiph.com>
 * @version ver1.0
 * @copyright (c) 2021 GoTensei Inc.
 */
class UserController_changePasswordUser extends TestCase
{
    /** @var string $username */
    ...
    /** @var string $uri */
    private $uri = "changePasswordUser";

    /**
     * Success Case 1
     * USER_TYPE = 1
     */
    public function test_changePasswordUser()
    {
        Auth::attempt([
