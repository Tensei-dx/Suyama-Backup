...
/**
 * <Class Name> UserController_getUsers
 *
 * <Overview> Class that is used to perform PHPUnit test
 *            to getUsers method in UserController
 * @package Test
 * @author TP Uddin <u-almujeer@tenseiph.com>
 * @version ver1.0
 * @copyright (c) 2021 GoTensei Inc.
 */
class UserController_getUsers extends TestCase
{
    /** @var string $username */
    ...
    /** @var string $uri */
    private $uri = "getUsers";

    /**
     * Success Case 1
     * USER_TYPE = 1
     */
    public function test_getUsers_1()
    {
        Auth::attempt([
     ...
     * USER_TYPE = 2
     */
    public function test_getUsers_2()
    {
        Auth::attempt([
            'username' => $this->username,
            'password' => $this->password
