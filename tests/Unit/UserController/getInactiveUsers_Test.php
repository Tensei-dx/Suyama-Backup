...
/**
 * <System Name> iBMS
 * <Program Name> getInactiveUsers_Test.php
 *
...
/**
 * <Class Name> UserController_getInactiveUsers
 *
 * <Overview> Class that is used to perform PHPUnit test
 *            to getInactiveUsers method in UserController
 * @package Test
 * @author TP Uddin <u-almujeer@tenseiph.com>
 * @version ver1.0
 * @copyright (c) 2021 GoTensei Inc.
 */
class UserController_getInactiveUsers extends TestCase
{
    /** @var string $username */
    ...
    /** @var string $uri */
    private $uri = "getInactiveUsers";

    /**
     * Success Case 1
     * USER_TYPE = 1
     */
    public function test_getInactiveUsers_1()
    {
        Auth::attempt([
     ...
     * USER_TYPE = 2
     */
    public function test_getInactiveUsers_2()
    {
        Auth::attempt([
            'username' => $this->username,
            'password' => $this->password
