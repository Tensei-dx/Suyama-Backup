...
class RoomController_getRoomFloor extends TestCase
{
    ...
    /** @var string $uri */
    protected $uri;
    public function test_getRoomFloor()
    {

        $id = 1;
        //Query
        $this->uri = "/getRoomFloor/$id";
        Auth::attempt([
        ...
        $expected = [
            [
                ...
                "FLOOR_MAP_DATA" => [
                    "roomMap" => [
                        [
                            "coor" => "M0.713 3.059 L0.621 41.768 L4.447 41.412 L4.447 14.423 L8.090 14.423 L8.090 2.704Z",
